    ...
    <div className="w-full max-w-md p-8">
      ...
      <form className="space-y-4">
        ...
        <div>
          ...
          <input type="password" className="w-full p-3 border rounded-md mt-1" placeholder="••••••••" />
        </div>
      ...
      <div className="flex gap-4">
        <button className="w-full border py-2 rounded-md flex items-center justify-center gap-2">🔍 Google</button>
        <button className="w-full border py-2 rounded-md flex items-center justify-center gap-2"> Apple</button>
      </div>
